...
class Ui_RegionSelector(object):
    def setupUi(self, RegionSelector):
        ...
        self.btnLoad.setGeometry(QtCore.QRect(10, 620, 101, 23))
        ...
        self.btnAddROI.setGeometry(QtCore.QRect(314, 620, 91, 31))
        ...
        self.lblROIName.setGeometry(QtCore.QRect(139, 662, 91, 16))
        self.lblROIName.setObjectName("lblROIName")
        self.leNewROI = QtWidgets.QLineEdit(self.centralwidget)
        self.leNewROI.setGeometry(QtCore.QRect(320, 670, 113, 22))
        self.leNewROI.setObjectName("leNewROI")
        self.label_2 = QtWidgets.QLabel(self.centralwidget)
        self.label_2.setGeometry(QtCore.QRect(320, 650, 101, 16))
        self.label_2.setObjectName("label_2")
        self.cbRegions = QtWidgets.QComboBox(self.centralwidget)
        self.cbRegions.setGeometry(QtCore.QRect(450, 667, 151, 26))
        ...
        self.btnDelROI.setGeometry(QtCore.QRect(12, 674, 91, 31))
